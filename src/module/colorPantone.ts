...
function createColorComponent(width: number = 150): ComponentNode {
...
async function createPantone(width: number = 150) {
  const colorComponent = createColorComponent(width);
