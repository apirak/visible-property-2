...
describe('convert RGB to OKLCH', () => {
  it('convert red color', () => {
    ...
    expect(result).toBe('oklch(50.66%, 20.79, 29.23)');
  });
  ...
  it('convert rgba(1, 100, 170, 0.75)', () => {
    ...
    expect(result).toBe('oklch(38.47%, 11.81, 252.86 / 75%)');
  });
  ...
  it('convert rgba(100, 110, 160, 0.25)', () => {
    ...
    const opacity = 0.25;
    const result = colorToOKLCH(rgb, opacity);
    expect(result).toBe('oklch(55.12%, 8.52, 149.79 / 25%)');
  });
  ...
  it('convert rgba(190, 150, 140, 1)', () => {
    ...
    const opacity = 1;
    const result = colorToOKLCH(rgb, opacity);
    expect(result).toBe('oklch(55.09%, 9.22, 79.26)');
  });
});
